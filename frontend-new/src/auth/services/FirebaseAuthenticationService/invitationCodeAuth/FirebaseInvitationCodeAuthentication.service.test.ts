...
describe("AuthService class tests", () => {
  ...
  test("should construct a singleton", async () => {
    ...
    const instance = await FirebaseInvitationCodeAuthenticationService.getInstance();

    // THEN the instance should be defined
    expect(instance).toBeDefined();

    // AND WHEN the singleton is constructed again
    const newInstance = await FirebaseInvitationCodeAuthenticationService.getInstance();
