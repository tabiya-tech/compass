...
jest.mock("src/chat/reaction/components/reactionReasonPopover/DislikeReasonPopover", () => {
  const actual = jest.requireActual("src/chat/reaction/components/reactionReasonPopover/DislikeReasonPopover");
  return {
    __esModule: true,
    ...actual,
    default: jest.fn(() => (
