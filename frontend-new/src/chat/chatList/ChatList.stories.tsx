...
export const SingleMessage: Story = {
  args: {
    messages: [
      createMessage("Hello, I'm Brújula", ConversationMessageSender.COMPASS, COMPASS_CHAT_MESSAGE_TYPE)
    ],
  },
};
...
export const MultipleMessages: Story = {
  args: {
    messages: [
      ...
      createMessage("Hi, I'm Brújula", ConversationMessageSender.COMPASS, COMPASS_CHAT_MESSAGE_TYPE),
