...
import CustomerSatisfactionRating, { DATA_TEST_ID as CUSTOMER_SATISFACTION_RATING_DATA_TEST_ID } from "src/feedback/overallFeedback/feedbackForm/components/customerSatisfactionRating/CustomerSatisfaction"; 
...
describe("ConversationConclusionFooter", () => {
  ...
  describe("render tests", () => {
    ...
    test("should not show customer satisfaction rating when already submitted", () => {
      ...
      // THEN expect the customer satisfaction rating component not to be displayed
