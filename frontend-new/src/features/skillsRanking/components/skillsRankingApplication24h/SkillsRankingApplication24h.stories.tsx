...
const createStateForGroup = (
  ...
  const state = getRandomSkillsRankingState(SkillsRankingPhase.PRIOR_BELIEF, group);
  state.application24h = prefilled;
  state.phases = [
    {
      name: SkillsRankingPhase.PRIOR_BELIEF,
