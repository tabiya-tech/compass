...
// Mock demand summary data
export const demandSummaryMock = {
  above_average_labels: [
    "self-management skills and competences",
    "information skills",
    "thinking skills and competences",
  ],
  below_average_labels: ["natural sciences, mathematics and statistics", "core skills and competences"],
  most_demanded_label: "self-management skills and competences",
  most_demanded_percent: 65.87,
  least_demanded_label: "natural sciences, mathematics and statistics",
  least_demanded_percent: 4.29,
  average_percent_for_jobseeker_skill_groups: 41.72,
  average_count_for_jobseeker_skill_groups: 418.0,
  province_used: "ALL",
  matched_skill_groups: 5,
};

const aboveAverageSkills = demandSummaryMock.above_average_labels.join(", ");
const belowAverageSkills = demandSummaryMock.below_average_labels.join(", ");
const mostDemandedSkillLabel = demandSummaryMock.most_demanded_label;
...
const SkillsRankingPriorBelief: React.FC<Readonly<SkillsRankingPriorBeliefProps>> = ({
  ...
  const handleSubmit = async () => {
    if (submitted || !startedEditing || !isOnline || currentPhase !== SkillsRankingPhase.PRIOR_BELIEF) {
      return;
    }
        ...
        <ChatBubble
          ...
          message={
            <>
              ...
              <strong>The more accurate your guesses are, the more airtime you will receive.</strong>
              <br />
              <br />
        ...
        >
          <Box padding={theme.fixedSpacing(theme.tabiyaSpacing.sm)}>
            <SkillsRankingSlider
              ...
              disabled={submitted || !isOnline || currentPhase !== SkillsRankingPhase.PRIOR_BELIEF}
            ...
            <Box mt={theme.spacing(2)} textAlign="right">
              <PrimaryButton
                ...
                disabled={submitted || !startedEditing || !isOnline || currentPhase !== SkillsRankingPhase.PRIOR_BELIEF}
