...
export const getRandomScore = (): SkillsRankingScore => {
  return {
    ...
    average_percent_for_jobseeker_skill_groups: Math.random() * 100,
    average_count_for_jobseeker_skill_groups: Math.random() * 1000,
    province_used: getRandomString(10),
    matched_skill_groups: Math.floor(Math.random() * 10) + 1,
