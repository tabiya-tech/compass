 ...
 *
 * We have this options because we have different usages of this service
 * one way is from the browser crypto
 * and another way is using Node.js crypto especially on tests.
 */
export type EncryptionServiceOptions = {
  /**
   * A function that converts a string to a buffer.
   */
  stringToBuffer: (string: string) => ArrayBuffer;
