...
const OverallFeedbackForm: React.FC<FeedbackFormProps> = ({ isOpen, notifyOnClose }) => {
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Typography variant="h3" data-testid={DATA_TEST_ID.OVERALL_FEEDBACK_FORM_DIALOG_TITLE}>
            Help us improve!
          </Typography>
          <PrimaryIconButton
            onClick={handleClose}
            ...
            data-testid={DATA_TEST_ID.OVERALL_FEEDBACK_FORM_DIALOG_BUTTON}
          >
            <CloseIcon data-testid={DATA_TEST_ID.OVERALL_FEEDBACK_FORM_DIALOG_ICON_BUTTON} />
          </PrimaryIconButton>
        </DialogTitle>
        <DialogContent
          data-testid={DATA_TEST_ID.OVERALL_FEEDBACK_FORM_DIALOG_CONTENT}
          sx={{
            padding:
              isSmallOrShortScreen
                ? theme.fixedSpacing(theme.tabiyaSpacing.sm)
        ...
        >
          <FormContent notifySubmit={handleFeedbackSubmit} />
        </DialogContent>
      </Dialog>
