...
import QuestionRenderer, {
  DATA_TEST_ID,
} from "src/feedback/overallFeedback/feedbackForm/components/questionsRenderer/QuestionRenderer";
...
describe("QuestionRenderer", () => {
  const getMockQuestion: (questionType: QuestionType) => DetailedQuestion = (questionType) => ({
      questionId: "q1",
      type: questionType,
