...
5. Set up the required environment variables:
   ...
   - The following environment variables can be set in the `env.js` file:
     ...
     - `FRONTEND_SUPPORTED_LANGUAGES`:(**Mandatory**) A JSON array of enabled locale codes (e.g., ["en-GB", "en-US","es-ES","es-AR"]). Refer to the constant [SupportedLocales](./src/i18n/constants.ts#SupportedLocales) for more about the supported locales. They must follow [IETF BCP 47](https://www.ietf.org/rfc/bcp/bcp47.txt) format.
