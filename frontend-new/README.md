...
5. Set up the required environment variables:
   ...
   - The following environment variables can be set in the `env.js` file:
     ...
     - `FRONTEND_ENABLE_SKILLS_RANKING`: (**Optional**) A boolean value to enable or disable the skills ranking feature. If set to true, the skills ranking feature will be enabled in the application.
