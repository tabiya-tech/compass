...
def _setup_identity_platform(*, basic_config: ProjectBaseConfig, frontend_domain: str, dependencies: list[pulumi.Resource], gcp_oauth_client_id: str, gcp_oauth_client_secret: str):
...
def deploy_auth(project: str, location: str, environment: str, frontend_domain: str, gcp_oauth_client_id: str, gcp_oauth_client_secret: str):
