# Data Protection
Overview of safeguarding sensitive personal data in the system.
...
- **Initialization Vector (IV)**: 96 bits Randomly generated using the WebCrypto API to ensure sufficient randomness as suggested in Section 8.2 IV Constructions of the [NIST SP 800-38D](https://nvlpubs.nist.gov/nistpubs/Legacy/SP/nistspecialpublication800-38d.pdf)
- **Tag Length**: 128 bits as it is the maximum length for GCM.
- By using completely random keys and IVs, the probability of using the same iv, key twice is 1/2^352 which is much less that the recommended as per Section 8 Uniqueness Requirement on IVs and Keys of the  [NIST SP 800-38D](https://nvlpubs.nist.gov/nistpubs/Legacy/SP/nistspecialpublication800-38d.pdf)
