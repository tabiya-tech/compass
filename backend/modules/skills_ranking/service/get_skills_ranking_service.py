...
async def get_skills_ranking_service(
        repository: ISkillsRankingRepository = Depends(get_skills_ranking_repository), user_preferences_repository: IUserPreferenceRepository = Depends(get_user_preferences_repository)) -> ISkillsRankingService:
