...
from features.skills_ranking.state.services.type import SkillsRankingState, SkillsRankingPhaseName, \
    SkillRankingExperimentGroup, SkillsRankingScore, \
...
def get_skills_ranking_state(
    ...
    return SkillsRankingState(
        ...
        correct_rotations=1 if phase == "PROOF_OF_VALUE" and (
                    experiment_group == SkillRankingExperimentGroup.GROUP_2 or experiment_group == SkillRankingExperimentGroup.GROUP_3) else None,
...
def _create_test_client_with_mocks() -> TestClientWithMocks:
    ...
    app.dependency_overrides[get_skills_ranking_state_repository] = lambda: mocked_skills_ranking_repository
