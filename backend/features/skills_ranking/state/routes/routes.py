...
from features.skills_ranking.state.repositories.get_skills_ranking_state_repository import get_skills_ranking_state_repository
...
def get_skills_ranking_router(auth: Authentication) -> APIRouter:
    ...
    async def _get_skills_ranking_state(
            ...
            skills_ranking_repository: ISkillsRankingStateRepository = Depends(get_skills_ranking_state_repository),
