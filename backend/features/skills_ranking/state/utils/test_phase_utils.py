...
def test_get_possible_next_states_group1():
    ...
    assert get_possible_next_phase("BRIEFING", SkillRankingExperimentGroup.GROUP_1) == ["BRIEFING", "PROOF_OF_VALUE_INTRO"]
    assert get_possible_next_phase("PROOF_OF_VALUE_INTRO", SkillRankingExperimentGroup.GROUP_1) == ["PROOF_OF_VALUE_INTRO", "PROOF_OF_VALUE"]
...
def test_get_possible_next_states_group2():
    ...
    assert get_possible_next_phase("BRIEFING", SkillRankingExperimentGroup.GROUP_2) == ["BRIEFING", "PROOF_OF_VALUE_INTRO"]
    assert get_possible_next_phase("PROOF_OF_VALUE_INTRO", SkillRankingExperimentGroup.GROUP_2) == ["PROOF_OF_VALUE_INTRO", "PROOF_OF_VALUE"]
    assert get_possible_next_phase("PROOF_OF_VALUE", SkillRankingExperimentGroup.GROUP_2) == ["PROOF_OF_VALUE", "PRIOR_BELIEF"]
    assert get_possible_next_phase("PRIOR_BELIEF", SkillRankingExperimentGroup.GROUP_2) == ["PRIOR_BELIEF", "PRIOR_BELIEF_FOR_SKILL"]
    ...
    assert get_possible_next_phase("PERCEIVED_RANK", SkillRankingExperimentGroup.GROUP_2) == [
        "PERCEIVED_RANK",
