        ...
        expected_operations=[
            {
                ...
                "users_statement": "Software Architect at ProUbis GmbH in Berlin (2010-2018) - Full-time."
            },
            {
                "data_operation": ContainsString("add"),
                "potential_new_experience_title": ContainsString("Project Manager"),
                "users_statement": "Project Manager at the University of Oxford (2018-2020) - Remote, paid job."
            }
        ]
    ),
    IntentAnalyzerToolTestCase(
        ...
        expected_operations=[
            {
                ...
                "users_statement": ContainsString("Sorry, I was actually a Cleaner at Acme Inc.")
            }
        ]
    ),
    IntentAnalyzerToolTestCase(
