...
def _mock_user_preference_repository() -> IUserPreferenceRepository:
    ...
    return MockedUserPreferenceRepository()  # type: ignore
...
class TestCreate:
    ...
    async def test_success(self, _mock_sensitive_personal_data_repository: ISensitivePersonalDataRepository,
        ...
        assert actual_sensitive_data.sensitive_personal_data == given_sensitive_data
        # AND sensitive_personal_data_skipped should be False
        assert actual_sensitive_data.sensitive_personal_data_skipped is False
...
class TestSkip:
    ...
    async def test_success(self, _mock_sensitive_personal_data_repository: ISensitivePersonalDataRepository,
        ...
        # AND sensitive_personal_data_skipped should be True
        assert actual_sensitive_data.sensitive_personal_data_skipped is True

    @pytest.mark.asyncio
    async def test_not_allowed_when_required(self,
                                             _mock_sensitive_personal_data_repository: ISensitivePersonalDataRepository,
                                             _mock_user_preference_repository: IUserPreferenceRepository,
                                             mocker: pytest_mock.MockerFixture):
        # GIVEN a user id
