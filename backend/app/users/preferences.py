...
async def _get_user_preferences(
        ...
        sensitive_personal_data_service: SensitivePersonalDataService,
        user_id: str,
...
def add_user_preference_routes(users_router: APIRouter, auth: Authentication):
    ...
    async def _get_user_preferences_handler(
            ...
            sensitive_personal_data_service: SensitivePersonalDataService = Depends(SensitivePersonalDataService),
