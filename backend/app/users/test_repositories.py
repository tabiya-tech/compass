...
class TestUserPreferenceRepository:
    ...
    async def test_insert_user_preference(self, get_user_preference_repository: Awaitable[UserPreferenceRepository]):
        # GIVEN a user id
        given_user_id = get_random_printable_string(10)
    ...
    async def test_update_user_preference(self, get_user_preference_repository: Awaitable[UserPreferenceRepository]):
        # GIVEN a user id
        given_user_id = get_random_printable_string(10)
    ...
    async def test_set_experiment_new_experiment(self, get_user_preference_repository: Awaitable[UserPreferenceRepository]):
        # GIVEN a user id
        given_user_id = get_random_printable_string(10)
    ...
    async def test_set_experiment_update_existing(self, get_user_preference_repository: Awaitable[UserPreferenceRepository]):
        # GIVEN a user id
        given_user_id = get_random_printable_string(10)
    ...
    async def test_set_experiment_multiple_experiments(self, get_user_preference_repository: Awaitable[UserPreferenceRepository]):
        # GIVEN a user id
        given_user_id = get_random_printable_string(10)
