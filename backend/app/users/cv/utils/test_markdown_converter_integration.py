...
async def test_convert_contains_content(filename: str, raw_bytes: bytes | None, input_relpath: str | None):
    ...
    markdown = convert_cv_bytes_to_markdown(file_bytes, filename)
...
@pytest.mark.parametrize("filename, raw_bytes, input_relpath", PARAMS)
async def test_convert_preserves_headings(filename: str, raw_bytes: bytes | None, input_relpath: str | None):
    from app.users.cv.utils.markdown_converter import convert_cv_bytes_to_markdown
    file_bytes = _load_bytes(filename, raw_bytes, input_relpath)
    markdown = convert_cv_bytes_to_markdown(file_bytes, filename)
...
async def test_convert_detects_images_when_present(filename: str, raw_bytes: bytes | None, input_relpath: str | None):
    from app.users.cv.utils.markdown_converter import convert_cv_bytes_to_markdown
    file_bytes = _load_bytes(filename, raw_bytes, input_relpath)
    markdown = convert_cv_bytes_to_markdown(file_bytes, filename)
