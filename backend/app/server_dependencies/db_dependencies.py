...
class CompassDBProvider:
    ...
    async def initialize_metrics_mongo_db(metrics_db: AsyncIOMotorDatabase, logger: logging.Logger):
        ...
        try:
            ...
            # - queries that filter by event_type, anonymized_session_id and anonymized_user_id (for upserting FeedbackProvided events)
            # - queries that filter by event_type, anonymized_session_id, anonymized_user_id and message_id (for upserting Reaction events)
