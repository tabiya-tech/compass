...
class IntentAnalyzerTool:
    ...
    async def execute(self,
        ...
        _llm = GeminiGenerativeLLM(
            system_instructions=_SYSTEM_INSTRUCTIONS.format(previously_extracted_data=json_data),
            config=LLMConfig(
        ...
        response_data, llm_stats = await self._llm_caller.call_llm(llm=_llm,
        ...
        for operation in response_data.collected_operations:
        ...
        return response_data.collected_operations, llm_stats
