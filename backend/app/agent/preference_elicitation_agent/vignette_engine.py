...
class VignetteEngine:
    ...
    async def _select_offline_with_personalization(
        ...
        self._logger.debug(
            "Hybrid selection: n_shown=%d, adaptive_phase_complete=%s, adaptive_vignettes_shown_count=%d",
            n_shown,
            getattr(state, "adaptive_phase_complete", False),
            getattr(state, "adaptive_vignettes_shown_count", 0),
        )
