        ...
        <_ABOUT_>
            ...
            - If I do not create an account, I can still explore my work experiences and skills, but if I log out or close the browser, 
              I will lose the progress and will have to start over. 
                        - Initially Brujula will gather basic information about all your work experiences, including any unpaid activities like volunteering or family contributions. 
                            Then, Brujula will dive deeper into each experience to capture the details that matter.    
        </_ABOUT_>
