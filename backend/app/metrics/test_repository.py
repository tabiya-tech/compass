...
class TestRecordEvent:
    ...
    async def test_record_multiple_user_account_creation_events_success(
        ...
        # GIVEN multiple events of the same type
    ...
    @pytest.mark.parametrize(
        "phase",
        [
            "INTRO", "COUNSELING", "CHECKOUT", "ENDED"
        ],
        ids=[
            "INTRO", "COUNSELING", "CHECKOUT", "ENDED"
        ]
    )
    async def test_record_multiple_conversation_phase_events_success(
            self,
            get_metrics_repository: Awaitable[CompassMetricRepository],
        ...
        # GIVEN multiple events of the same type
        given_events = [get_conversation_phase_event(phase), get_conversation_phase_event(phase)]
        repository = await get_metrics_repository
    ...
    async def test_record_mixed_event_success(
        ...
        given_events = [get_user_account_created_event(), get_conversation_phase_event("ENDED")]
        repository = await get_metrics_repository
