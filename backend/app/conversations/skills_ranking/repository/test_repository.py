...
async def get_skills_ranking_repository(in_memory_skills_ranking_database) -> SkillsRankingRepository:
    skills_ranking_db = await in_memory_skills_ranking_database
    return SkillsRankingRepository(db=skills_ranking_db)
