...
class SkillResponse(BaseModel):
    ...
    @staticmethod
    def from_skill_entity(skill_entity: SkillEntity | tuple[int, SkillEntity]) -> "SkillResponse":
        """
        Build a SkillResponse from a SkillEntity.
        """

        if isinstance(skill_entity, tuple):
            # If the skill_entity is a tuple, extract the SkillEntity from it
            skill_entity = skill_entity[1]
