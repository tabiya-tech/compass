...
from common_libs.test_utilities.mock_application_state import get_application_state
...
class TestAdd:
    ...
    @pytest.mark.asyncio
    async def test_add_liked_reaction_success(self, _mock_reaction_repository: IReactionRepository, _mock_application_state_manager:IApplicationStateManager, _mock_conversation_memory_manager:IConversationMemoryManager, mocker: pytest_mock.MockerFixture):
        ...
        _mock_application_state_manager.get_state=AsyncMock(return_value=get_application_state(self._given_session_id))
        ...
        service = ReactionService(reaction_repository=_mock_reaction_repository, conversation_memory_manager=_mock_conversation_memory_manager, application_state_manager=_mock_application_state_manager)
    ...
    @pytest.mark.asyncio
    async def test_add_disliked_reaction_success(self, _mock_reaction_repository: IReactionRepository, _mock_application_state_manager:IApplicationStateManager, _mock_conversation_memory_manager:IConversationMemoryManager, mocker: pytest_mock.MockerFixture):
    ...
    @pytest.mark.asyncio
    async def test_add_reaction_to_user_message_raises_error(self, _mock_reaction_repository: IReactionRepository, _mock_application_state_manager:IApplicationStateManager, _mock_conversation_memory_manager:IConversationMemoryManager, mocker: pytest_mock.MockerFixture):
        # GIVEN a liked reaction request
        given_reaction = ReactionRequest(kind=ReactionKind.LIKED)

        # AND the message with the given message_id is a USER message in the conversation context
        _mock_application_state_manager.get_state=AsyncMock(return_value=get_application_state(self._given_session_id))
        given_conversation_context = ConversationContext(
            all_history=ConversationHistory(
                turns=[
                    ConversationTurn(
                        index=0,
                        ...
                        output=AgentOutput(
                            message_id="compass_response_123",
    ...
    @pytest.mark.asyncio
    async def test_add_repository_throws_an_error(self, _mock_reaction_repository: IReactionRepository, _mock_application_state_manager:IApplicationStateManager, _mock_conversation_memory_manager:IConversationMemoryManager, mocker: pytest_mock.MockerFixture):
    ...
    @pytest.mark.asyncio
    async def test_add_conversation_memory_manager_throws_an_error(self, _mock_reaction_repository: IReactionRepository, _mock_application_state_manager:IApplicationStateManager, _mock_conversation_memory_manager:IConversationMemoryManager, mocker: pytest_mock.MockerFixture):
        ...
        _mock_conversation_memory_manager.get_conversation_context = AsyncMock(side_effect=given_error)
    ...
    @pytest.mark.asyncio
    async def test_add_application_state_manager_throws_an_error(self, _mock_reaction_repository: IReactionRepository, _mock_application_state_manager:IApplicationStateManager, _mock_conversation_memory_manager:IConversationMemoryManager, mocker: pytest_mock.MockerFixture):
...
class TestDelete:
    ...
    @pytest.mark.asyncio
    async def test_delete_success(self, _mock_reaction_repository: IReactionRepository, _mock_application_state_manager:IApplicationStateManager, _mock_conversation_memory_manager:IConversationMemoryManager, mocker: pytest_mock.MockerFixture):
