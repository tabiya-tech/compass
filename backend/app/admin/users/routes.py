...
def get_admin_users_routes() -> APIRouter:
    """
    ...
    @router.post(
        ...
        description="Create a new user with Firebase Auth and assign an access role.",
    )
    ...
    @router.delete(
        ...
        description="Delete a user from Firebase Auth and remove their access role.",
    )
    ...
    @router.patch(
        ...
        description="Update a user's role in Firestore.",
    )
